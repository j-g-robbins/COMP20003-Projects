...
void print_outfile(double cpu_time_used) {
	FILE *out = fopen("output.txt", "w");
		
	fprintf(out, "STATS:\nExpanded nodes: %'d\nGenerated nodes: %'d\n", expanded_nodes, generated_nodes);
	fprintf(out, "Solution Length: %d\n", solution_size);
	fprintf(out, "Number of Pegs Left: %d\n", num_pegs( &(solution[solution_size]) ) );
	fprintf(out, "Expanded/seconds: %d\n", (int)(expanded_nodes/cpu_time_used) );
	fprintf(out, "Time (seconds): %f\n", cpu_time_used );
